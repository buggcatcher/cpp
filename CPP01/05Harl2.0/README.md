...
#### Objective
Automate Harl's repetitive comments, classified by log level.
...
- Implement a `Harl` class with private member functions:
  ...
  - `void warning(void);`
  - `void error(void);`
- Add a public member function that calls the appropriate function based on the level passed as a parameter.
  - `void complain(std::string level);`
- Log levels:
  - **DEBUG**: Debug messages for problem diagnosis.
  - **INFO**: Informational messages for tracing execution.
  - **WARNING**: Indicates a potential issue.
  - **ERROR**: Indicates a critical, unrecoverable error.
- Example messages for each level are provided in the exercise description.
- Use pointers to member functions to implement the `complain` method without using if/else statements.
...
**The goal of this exercise is to use pointers to member functions. This is not a suggestion. Harl has to complain without using a forest of if/else if/else.**
